<%@ Page Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<ProductView<Product>>" %>
    ...
    <div class="rightColumn">
        ...
        <div>
            ...
            <div class="product">
                ...
                Description: <span class="price"><%= p.Description %></span><br />
                ...
                Categories: <% Html.Repeat(p.Categories, cat => { %>
                    ...
                    <br />
                    <a href="/home/delete/?id=<%= p.Id %>">delete</a>
            </div>
            <%} %>
        </div>
